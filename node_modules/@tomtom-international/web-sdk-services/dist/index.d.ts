...
declare namespace tt {
  ...
  interface Services {
     ...
     * Parameters need to be passed to the constructor.
     * The final response from the service is a HTML string with the copyrights information that have to be displayed. The whole respose is wrapped into a div element with the id copyrightMessage.
     * Country names are enclosed within h4 elements and the copyrights information per each supplier is enclosed in p elements.
     * This makes styling with CSS fairly easy. An example response may look like this:
     */
    copyrights: CopyrightsServiceFactory;
     ...
     */
    copyrightsCaption: CopyrightsCaptionServiceFactory;
     ...
     */
    incidentDetails: IncidentDetailsServiceFactory;
  ...
  >;
  type CopyrightsServiceFactory = ServiceFactory<CopyrightsOptions>;
  type CopyrightsV2ServiceFactory = ServiceFactory<
    Pick<CopyrightsOptions, "key" | "trackingId">,
    CopyrightsV2Response
  >;
  type CopyrightsCaptionServiceFactory = ServiceFactory<
    CopyrightsCaptionOptions
  >;
  type CopyrightsCaptionV2ServiceFactory = ServiceFactory<
    Pick<CopyrightsCaptionOptions, "key" | "trackingId">,
  ...
  type IncidentDetailsServiceFactory = ServiceFactory<
    IncidentDetailsOptions,
  ...
  type CopyrightsOptions = {
     ...
     * The x axis value.
     *
     * This option specifies the x axis value in a slippy map
     * format. Only used for tile-level copyright calls.
     * @default None
     */
    x?: number;
     ...
     * The y axis value.
     *
     * This option specifies the y axis value in a slippy map
     * format. Only used for tile-level copyright calls.
     * @default None
     */
    y?: number;
     ...
     * The zoom level.
     *
     * This option specifies the zoom level in a slippy map
     * format. Only used for tile-level copyright calls.
     * @default None
     */
    zoom?: number;
  ...
  type IncidentDetailsOptions = {
    ...
    /**
     * Determines if the service should include details of incidents
     * that are clustered.
     *
     ...
     * Note that when this is set to false, the toGeoJson() method available
    ...
    /**
     * Determines if clustered incidents data
     * should be available in the cluster feature.
     *
     * If this is set to true, the toGeoJson() method available
    ...
    /**
     * Style name, needs to be one of 's1', 's2', 's3', 'night'. This needs to match
  ...
  type IncidentDetailsProperties = {
    /**
     * The ID of the traffic incident, common among Traffic Incident API services
    ...
    /**
     * From: The name of the intersection or location where the traffic
     * due to the incident starts.
     */
    from?: string;

    /**
     * To: The name of the intersection or location where the traffic
    ...
    /**
     * Cause of the incident, in the language requested.
     */
    ...
    /**
     * The point representing the actual position of the incident.
     */
    originalPosition?: LngLatLike;
     ...
     * Multiple road numbers will delimited by slashes.
     */
    roadNumber?: string;
    ...
    /**
     * Estimated end date of the incident.
     */
    endDate?: string;
    ...
    features?: Array<IncidentDetailsProperties>;
  };

  type IncidentDetailsResponse = GenericServiceResponse & {
    toGeoJson(): GeoJSON.FeatureCollection<Point, IncidentDetailsProperties>;
    getTrackingId(): string;
  };
